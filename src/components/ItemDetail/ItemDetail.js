        ...
        <div className='container-item-detail'>
            <div className='product'>
                ...
                <div className='product__info'>
                    ...
                    <span className='cartel-oferta'>{precioOferta === '' ? '' : 'OFERTA'}</span>
                    <div className='price-detail'>
                        <span className='precio-anterior'>{precioOferta !== '' && '$' + precio}</span>
                        <span className='precio-actual'>{precioOferta === '' ? '$' + precio : '$' + precioOferta}</span>
                    </div>
